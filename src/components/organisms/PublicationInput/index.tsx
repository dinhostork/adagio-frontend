...
export const PublicationInput = () => {
  ...
  const handleEmojiClick = (emoji) => {
    ...
    inputRef.current.setSelectionRange(startPos + emojiImage.length, startPos + emojiImage.length);
  };
  ...
  >
    ...
    <EmojiPicker onEmojiClick={handleEmojiClick} theme="dark" height={400} />
  </div>
)}
